...
Github
git clone - Просмотр удалённых репозиториев
 git remote - Добавление удалённых репозиториев
 git fetch  - Получение изменений из удалённого репозитория 
git push origin master - Отправка изменений в удалённый репозиторий
git remote show - Просмотр удалённого репозитория
git remote rename,remove - Удаление и переименование удалённых репозиториев
